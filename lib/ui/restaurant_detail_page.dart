...
import 'package:submission_dua/provider/restaurant_detail_provider.dart';
import 'package:submission_dua/ui/add_comment.dart';
import 'package:submission_dua/widgets/comment_restaurant.dart';
import 'package:submission_dua/widgets/custom_scaffold.dart';
    ...
    return Consumer<RestaurantDetailProvider>(
      builder: (context, state, _) {
        if (state.state == ResultDetailState.loading) {
          ...
          return   _DetailPage(restaurant: state.result.restaurant,);
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              child: Image.network("https://restaurant-api.dicoding.dev/images/small/${widget.restaurant.pictureId}",fit: BoxFit.cover,height: 300,)
              ),  
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[ 
                    Column(
                      children: <Widget>[
                        const Icon(Icons.map, color: Colors.blueAccent, size: 30.0,), 
                  ...
                  children: widget.restaurant.categories.map((item) {  
                    return Container(
                      ...
                      decoration: BoxDecoration(   
                          ...
                          boxShadow: const [
                            BoxShadow(color: Color.fromARGB(255, 205, 221, 241), spreadRadius: 3),
                          ],
                        ),
                  ...
                  children: widget.restaurant.menus.foods.map((item) {  
                    return Container(
                      ...
                      child: ClipRRect(
                            ...
                            child:  Column(
                              children:  [
                                Image.asset("assets/images/food.jpg", fit: BoxFit.cover,height: 60,width: 60,),
                                Text(item.name,
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                      style: myTextTheme.caption),
                  ...
                  children: widget.restaurant.menus.drinks.map((item) {  
                    return Container(
                      ...
                      child: ClipRRect(
                            ...
                            child:  Column(
                              children:  [ 
                                Image.asset("assets/images/drink.jpg", fit: BoxFit.cover,height: 60,width: 60,),
                                Text(item.name,
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                      style: myTextTheme.caption,),
                                  ...
                                  if(value != null) {  
                                    ...
                                    List<CustomerReview> newList = [];
                                     ...
                                     for (var element in args) {
                                        CustomerReview newData = CustomerReview(name: element.name, review: element.review, date: element.date);
                                        newList.add(newData);
                                     }
              ...
              Padding(
                ...
                child: Container(
                    decoration: BoxDecoration(
                      ...
                      child: SizedBox(
                        height: 300,
                        child: CommentRestaurant(review: widget.restaurant.customerReviews.reversed.toList()),
                      ),
                  ),
              ), 
              const SizedBox(
